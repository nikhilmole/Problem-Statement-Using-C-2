...
unsigned int TurnOnBit(unsigned int number, int position) 
{
...
int main() 
{
    ...
    modifiedValue = TurnOnBit(value, position);
    printf("The modified number after turning on the bit at position %d is: %u\n", position, modifiedValue);
